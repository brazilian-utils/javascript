...
| `date.compare` | `CivilDate, CivilDate` | library | only candidate, cost none/constant |
...
| `dec.abs` | `Decimal<2>` | library | only candidate, cost none/constant |
...
| `int.mod` | `Int[0..990], Int[11..11]` | native | only candidate, cost none/constant; Go truncates, which is the Core's rule |
...
| `str.codeAt` | `Digits[11], Int[10..10]` | native | only candidate, cost none/constant; indexing a string yields a byte |
| `str.codeAt` | `Digits[11], Int[9..9]` | native | only candidate, cost none/constant; indexing a string yields a byte |
...
Mix: 279 native, 23 library, 12 portable.
