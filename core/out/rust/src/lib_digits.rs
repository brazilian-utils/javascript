...
pub fn keep_alphanumeric(value: String) -> String {
    return value
        .chars()
        .filter(|&ch| {
            let c = ch as u32;
...
pub fn keep_digits(value: String) -> String {
    return value
        .chars()
        .filter(|&ch| {
            let c = ch as u32;
...
pub fn is_repeated_run(value: String) -> bool {
...
pub fn digit_at(value: String, index: i64) -> i64 {
