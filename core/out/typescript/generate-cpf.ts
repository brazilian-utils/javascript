...
import { cpfCheckDigit, cpfCheckDigit1, randomCpfBase } from "./lib/cpf.ts";
...
export function generateCpfWith(env: Capabilities): string {
	...
	const firstDigit: string = cpfCheckDigit(base + "00").toString();
	const secondDigit: string = cpfCheckDigit1(
		base + firstDigit + "0",
	).toString();
