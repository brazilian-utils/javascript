...
## [2.5.0](https://github.com/brazilian-utils/javascript/compare/2.4.0...2.5.0) (2026-09-26)


### Features

* add toStandardSchema, a Standard Schema wrapper for the validators ([c9cb205](https://github.com/brazilian-utils/javascript/commit/c9cb205041e1a1e7483ac5149e25e4fde924e477))
* Standard Schema wrapper, JSR, pkg.pr.new, docs previews and a playground ([bdd4e26](https://github.com/brazilian-utils/javascript/commit/bdd4e26b5215b02517c791092ae31b82c718476c))


### Bug Fixes

* **build:** keep the documentation out of the library's type-check ([f94463d](https://github.com/brazilian-utils/javascript/commit/f94463db4e0b2d593b0e80dbfec3cd4f6b6d8725))
* **build:** the document field templates stop breaking the package build ([cd0c587](https://github.com/brazilian-utils/javascript/commit/cd0c58758c2c4edde16eed07c4dafd7ca0c80bf3))
* **build:** the document field templates stop breaking the package build ([894338f](https://github.com/brazilian-utils/javascript/commit/894338f5a26cb982748c97997d90b3edff2ebf38))
* **capitalize:** keep a word stable when its first letter changes length between cases ([72f733b](https://github.com/brazilian-utils/javascript/commit/72f733b784779558320677c44cf6365ea4647437))
* **capitalize:** keep a word stable when its first letter changes length between cases ([459a89a](https://github.com/brazilian-utils/javascript/commit/459a89aee3af493b9b6507f17d3236c339c6912a))
* **deps-dev:** drop extract-zip by overriding @puppeteer/browsers to 3.x ([05195fa](https://github.com/brazilian-utils/javascript/commit/05195fa8e43609d5382cf25515e965320529fa3f))
* **docs:** a CEP that no service knows stops the Angular form from looking ([e9ad292](https://github.com/brazilian-utils/javascript/commit/e9ad292d641e3a86a7dc11744136d672f9cae66c))
* **docs:** build the Vercel preview when the last deployed commit is gone ([c6114ae](https://github.com/brazilian-utils/javascript/commit/c6114aec0ec0667ec3456279dc191471f4728e9b))
* **docs:** declare the autocomplete column of the examples table ([fadeb57](https://github.com/brazilian-utils/javascript/commit/fadeb5721a120c2a37ebb8a43898208a192c655b))
* **docs:** load Angular's compiler before the Angular demo and its packages ([ec7ba05](https://github.com/brazilian-utils/javascript/commit/ec7ba05ae2dce0bcf0ef737fdfa154671aaaa588))
* **docs:** point the Angular examples at the folder they live in ([df1a101](https://github.com/brazilian-utils/javascript/commit/df1a10125aeef182cac8804ad90caa5d3c452a31))
* **docs:** show every file of an example, and hand React a ref ([fab6408](https://github.com/brazilian-utils/javascript/commit/fab6408b10bc4382378f4b5c866aeac850e5a980))
* **docs:** skip the Vercel preview only when docs are unchanged since the branch's last deployment ([8e8d326](https://github.com/brazilian-utils/javascript/commit/8e8d326597277bf9d5c49e92058744b24ac30c7f))
* **docs:** the language switch keeps the page the reader is on ([ce2df9c](https://github.com/brazilian-utils/javascript/commit/ce2df9cce27c904c2a8edfef34ace6a7afb25a92))
* **docs:** the language switch keeps the page the reader is on ([1cd1698](https://github.com/brazilian-utils/javascript/commit/1cd1698727fa8c93b10a9c97339d954410614927))
* resolve the open Dependabot and code scanning alerts ([69e9b1f](https://github.com/brazilian-utils/javascript/commit/69e9b1f7de02bca3f6a4bc7c86214aec5786f690))
* **site:** show the Portuguese cover page ([37a6151](https://github.com/brazilian-utils/javascript/commit/37a6151d18be1b50205afd5ed51fa9e27a237f41))


### Documentation

* **contributing:** describe the new shape of a utilities section ([d899102](https://github.com/brazilian-utils/javascript/commit/d899102350f6848b882f743dae34483fb7313cf9))
* **contributing:** document how code review is done and what it checks ([3f73329](https://github.com/brazilian-utils/javascript/commit/3f73329c50a88faa13c2a19e0b9fc9bc45e5dc20))
* **contributing:** document how code review is done and what it checks ([3f7c753](https://github.com/brazilian-utils/javascript/commit/3f7c75358411323cfa9c6c2f098a6e19ba399127))
* **contributing:** document the datasets, the test arbitraries, JSR and the previews ([a791bd0](https://github.com/brazilian-utils/javascript/commit/a791bd0677f5228ea2a1e237e50db6a339034ec2))
* document generateCpf state parameter ([c20a485](https://github.com/brazilian-utils/javascript/commit/c20a4858ab85f4b74e3ff8def9afe5f7ce455ed7))
* document generateCpf state parameter ([080016a](https://github.com/brazilian-utils/javascript/commit/080016afc8a28a15f13a3c2c178d1193e274cc1c))
* **examples:** each field the way its framework expects ([0e1325f](https://github.com/brazilian-utils/javascript/commit/0e1325f94e0471ca53115b6f4db54febdaca3fb1))
* **examples:** fix the accessibility of the fields and show the files like an editor ([c37d679](https://github.com/brazilian-utils/javascript/commit/c37d6790e6acfb4d89392de2d6e3bb664db8bafe))
* **examples:** follow each framework's current conventions ([74c1316](https://github.com/brazilian-utils/javascript/commit/74c1316c4179ae05fd7621cba18af5170d6b5b6f))
* **examples:** framework tabs with live demos and a caret-aware CPF mask ([888ebc2](https://github.com/brazilian-utils/javascript/commit/888ebc22587809207a773311ccd4c9127ee4aa8a))
* **examples:** give each field an errorMessage prop and each framework its own mask ([be91fe9](https://github.com/brazilian-utils/javascript/commit/be91fe9d342008b98a55878d0eb75c957fb56336))
* **examples:** give the demos the site's own theme, fix the tab underline and the iframe scrollbar ([55e068e](https://github.com/brazilian-utils/javascript/commit/55e068eb6ff69f4189269eb1c842e8028d8afa10))
* **examples:** hand the CPF to the parent component in each framework ([057d039](https://github.com/brazilian-utils/javascript/commit/057d039d02c35ce03a1289aedc3a8c52027ca05b))
* **examples:** let the field mask and the form validate ([63985cf](https://github.com/brazilian-utils/javascript/commit/63985cff9f5704bc183ed161f01ab2668cc5711f))
* **examples:** let the React hook own the input, value and all ([0e97da4](https://github.com/brazilian-utils/javascript/commit/0e97da401f1aa78bbedccbf16a629b3d86d27913))
* **examples:** mask inside React's own event, which is what works either way ([26b1da5](https://github.com/brazilian-utils/javascript/commit/26b1da53285d05a86cc7755f9a3711afa3e40347))
* **examples:** move what is specific to each framework into its tab ([23f93dd](https://github.com/brazilian-utils/javascript/commit/23f93dd37551dd220e774f78cc38a1b18309ccf8))
* **examples:** one example page per task, starting with a generic document field ([e6ac552](https://github.com/brazilian-utils/javascript/commit/e6ac5524c16bd397caa5a2c874d73f74eb03d2dd))
* **examples:** one file per example, shared by both languages, live in a lazy iframe ([42c7fde](https://github.com/brazilian-utils/javascript/commit/42c7fdeeb898e422b7041ea636097e35c6bd3a0f))
* **examples:** one focused example per document instead of a generic field ([b3bd350](https://github.com/brazilian-utils/javascript/commit/b3bd3506f29552bf7ba2bd0d87068785a8fb2e32))
* **examples:** report both values from the React hook ([ccb6000](https://github.com/brazilian-utils/javascript/commit/ccb6000a5b6f0bec8cf5c1480b574eba6bdf98ed))
* **examples:** report both values from the Vue and Angular masks too ([de9168f](https://github.com/brazilian-utils/javascript/commit/de9168fbf4fd1dc0fb63ff9d7754c98ea68cc988))
* **examples:** show each field in the form library most projects use ([2de274a](https://github.com/brazilian-utils/javascript/commit/2de274a9bedeac25ebe0582ab7f2b124bde1c747))
* **examples:** show the Standard Schema in a form library that takes it ([0a64243](https://github.com/brazilian-utils/javascript/commit/0a64243877746edfe58105e25d1250ec66063e6b))
* **examples:** show the Standard Schema in four libraries that take it ([1194f35](https://github.com/brazilian-utils/javascript/commit/1194f35556c3450da3eb5e7304f4a039fdb90228))
* **examples:** size each live demo to its content ([0775c1b](https://github.com/brazilian-utils/javascript/commit/0775c1b1ad3421ea0d433f119d74b13384448769))
* **examples:** tie each message to its field and add a schema tab ([1fb8ce6](https://github.com/brazilian-utils/javascript/commit/1fb8ce68652a181615e6add321fefea7ce5fbb64))
* **examples:** write the mask where each framework puts it ([966295b](https://github.com/brazilian-utils/javascript/commit/966295b93c98d7b5e285d2324247bd600979467f))
* **guides:** a document field is a component, not an attribute on another one ([d5918c9](https://github.com/brazilian-utils/javascript/commit/d5918c9a945670d8f891729e0eacb45b6c23f931))
* **guides:** a form that fills an address from a CEP ([d222a3a](https://github.com/brazilian-utils/javascript/commit/d222a3a472bb3e86d3c962298f697ed0b23071d2))
* **guides:** a state picker that loads its cities on demand ([16f152c](https://github.com/brazilian-utils/javascript/commit/16f152c7f564f09d42cebe29c3a437379604e39b))
* **guides:** a submit shows the values it would send ([787f2ac](https://github.com/brazilian-utils/javascript/commit/787f2ac9501468309dda2593bb92abb27f457477))
* **guides:** ask by value, and borrow the field the other guide builds ([c7f008a](https://github.com/brazilian-utils/javascript/commit/c7f008a010398614ff1d063da5830bba2a96c1b6))
* **guides:** build a field once and dress it up per document ([27e1305](https://github.com/brazilian-utils/javascript/commit/27e13057723c5f85d305af20927ad7052c0eee63))
* **guides:** do the asking properly, and lay a demo out like a form ([115348f](https://github.com/brazilian-utils/javascript/commit/115348faa52d948bbed2ca9dc30f0783107552bc))
* **guides:** each framework keeps its templates in a folder of its own ([a304d71](https://github.com/brazilian-utils/javascript/commit/a304d7191343b6bf7eca211fcfa927e207bb5c01))
* **guides:** give the schemas a guide of their own ([d715484](https://github.com/brazilian-utils/javascript/commit/d7154849f70e560715f234d2b725943bd18d2954))
* **guides:** the Angular address form holds its fields the way the others do ([c4774b0](https://github.com/brazilian-utils/javascript/commit/c4774b08b2013294fc43fdd35b57501cd4ec547f))
* **guides:** the Angular examples lay out like the ones beside them ([9223ff1](https://github.com/brazilian-utils/javascript/commit/9223ff1f3ed68bffbc5246137c0c1b11b7473052))
* **guides:** the demo comes after what the page says about it ([5e77e09](https://github.com/brazilian-utils/javascript/commit/5e77e090299102db68a360ed45ef90c108ca475b))
* **guides:** the document picker leads the strip of tabs ([48ff536](https://github.com/brazilian-utils/javascript/commit/48ff5366089a81f5752b6a35e0fca00edacfe155))
* **guides:** the document sits at the end of the strip of tabs ([02ee925](https://github.com/brazilian-utils/javascript/commit/02ee925d678fb8b3fff7e6f7d75e05511d9a6e05))
* **guides:** the guide asks which document in words ([1c97835](https://github.com/brazilian-utils/javascript/commit/1c978352fa4023c27134a75f2f8d7ef194941fc2))
* **guides:** the schema guide is about schema libraries ([d66d8b6](https://github.com/brazilian-utils/javascript/commit/d66d8b64d287e43c932506d6d87c3b43f26084ad))
* **guides:** the state and city guide drops a table it no longer wants ([d9f8e92](https://github.com/brazilian-utils/javascript/commit/d9f8e92c0034bcdb6f5d365dcfa4f0d6e21d28bb))
* **guides:** the state and city lists load when their select is opened ([cd48e25](https://github.com/brazilian-utils/javascript/commit/cd48e2511506058f71c52a3822281fcca51750a4))
* **guides:** the vanilla address form fills its fields by name ([d2090d3](https://github.com/brazilian-utils/javascript/commit/d2090d3224395e5b2e4e711d68f804d11846d439))
* **readme:** drop the static bundle badge ([e0b6626](https://github.com/brazilian-utils/javascript/commit/e0b66260d77ac90a81d125ea45b22c5129d60916))
* **readme:** link the OpenSSF Best Practices badge ([0d0be92](https://github.com/brazilian-utils/javascript/commit/0d0be92210a985b8ffc2fdc1a066aa4931946c9e))
* **readme:** link the OpenSSF Best Practices badge ([cd10627](https://github.com/brazilian-utils/javascript/commit/cd106278d439ac6de4e4f8af60d0117af2cc6f8b))
* replace the playground with a CPF field example in React, Vue, Angular and plain JavaScript ([d7f4ee7](https://github.com/brazilian-utils/javascript/commit/d7f4ee79fb2fd7468bda4368508289ef25fdc1f9))
* restructure the utilities reference into short sections ([11ecabf](https://github.com/brazilian-utils/javascript/commit/11ecabf833d8cd273b047d3872f73accaf263071))
* rewrite the getting started, README and migration pages in plain language ([f6e64b9](https://github.com/brazilian-utils/javascript/commit/f6e64b9384ebc6580dc9f9f8dcdebbb2ebff0b96))
* security response timeline, disclosure, release verification, DCO and MAINTAINERS.md ([09fada1](https://github.com/brazilian-utils/javascript/commit/09fada1134ad072a0a1f1502f186605c3d0e83f8))
* **security:** add the secrets, dependency and static-analysis policies and a threat model ([8e1fed2](https://github.com/brazilian-utils/javascript/commit/8e1fed2391b64f52a57f0fb63fc587f8c0515734))
* **site:** add a playground that runs the published package in the browser ([ab6c6ad](https://github.com/brazilian-utils/javascript/commit/ab6c6ad7de70621d0bc74a235e8d66675fb31556))
* **site:** add the Context7 chat widget, page keywords and the agent rule tip ([e629d74](https://github.com/brazilian-utils/javascript/commit/e629d745331c965bd3c5f5ea29e8a5a89937f048))
* **site:** add the Docs7 analytics script ([b08f862](https://github.com/brazilian-utils/javascript/commit/b08f862c732010251c9b992447df6f1647f540ad))
* **site:** add the Google Search Console verification tag ([2b2c735](https://github.com/brazilian-utils/javascript/commit/2b2c73518fbfdad820e4760b19fee99c4d836c94))
* **site:** add the Google Search Console verification tag ([69d2126](https://github.com/brazilian-utils/javascript/commit/69d212624fbe2a352852123549332b4950c60a2b))
* **site:** advertise the Markdown sources and preconnect to the CDNs ([f8ed454](https://github.com/brazilian-utils/javascript/commit/f8ed4543728e683c53c8f3b23b47f6824076cbf2))
* **site:** apply the review of the shell and the site generator ([7570e0a](https://github.com/brazilian-utils/javascript/commit/7570e0a6aa13fdcbf1054b482a4be787d0628927))
* **site:** drop the Docs7 site setup and its analytics script ([f8e2993](https://github.com/brazilian-utils/javascript/commit/f8e29935da6ffd9abaa210a52c982fd3b7526934))
* **site:** move the site's styles into one stylesheet shared by every page and the live demos ([5b4adf6](https://github.com/brazilian-utils/javascript/commit/5b4adf6b4d4013ac3b09d7a1c43babc14e29d8bb))
* **site:** per-page metadata in the shell copies, one canonical Portuguese home ([9d089ad](https://github.com/brazilian-utils/javascript/commit/9d089adaba5bd62a2f903b35bbc24d96cd263a92))
* **site:** publish the docs on Docs7 and make them agent-ready ([694e93f](https://github.com/brazilian-utils/javascript/commit/694e93fd1302d142c7f129920127d5e5229b5a23))
* **site:** real URLs, per-page metadata and crawler files for brazilian-utils.com.br ([41f295c](https://github.com/brazilian-utils/javascript/commit/41f295cb11c19347334516541ad7bfa3c4343eb0))
* **site:** SEO and agent readiness for brazilian-utils.com.br ([1982b01](https://github.com/brazilian-utils/javascript/commit/1982b014b92ed5766931122006432875d47548ef))
* trim the utilities reference to what a caller needs ([dbfe432](https://github.com/brazilian-utils/javascript/commit/dbfe43233eca1ee9a7a909fec02697ed1a7e38c6))
* **utilities:** reshape the toStandardSchema section and move it to the end ([608dce5](https://github.com/brazilian-utils/javascript/commit/608dce533809b4ca200d8d3001a005f95397d996))
