 ...
 * `scripts/banks.ts`.
 *
 * 463 of the 492 entries are the participants the list publishes today. The other
 * 29, the ones `LEGACY_BANK_CODES` lists, are codes it no longer publishes, kept because they
 * still appear in documents filled in while the institution had them:
 * 029, 062, 098, 114, 117, 177, 184, 253, 270, 279, 285, 306, 309, 311, 313,
 * 325, 328, 340, 343, 367, 371, 429, 442, 459, 471, 545, 720, 739, 746.
 *
...
export const BANKS: readonly Omit<Bank, "legacy">[] = [
 ...
 */
export const LEGACY_BANK_CODES: readonly string[] = [
	"029",
	"062",
	"098",
	"114",
