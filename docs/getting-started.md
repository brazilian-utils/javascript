...
| --- | --- | --- | --- |
| `getCid10` | CID-10 V2008 categories and subcategories, with the DATASUS descriptions | 1030.4 KB | 146.8 KB |
...
| `isValidCid10` | CID-10 V2008 category and subcategory codes, without the descriptions | 27.1 KB | 7.4 KB |
