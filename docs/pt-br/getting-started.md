...
Você pode conferir a lista de utilitários [clicando aqui](pt-br/utilities.md). Os [exemplos](pt-br/examples.md) mostram como usá-los num campo de formulário em React, Vue ou Angular.
